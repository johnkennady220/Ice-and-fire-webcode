...
displayB.style.background="url('https://images.unsplash.com/photo-1621944193575-816edc981878?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NTV8fGJvb2slMjBjb3ZlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60');"
...
const getBooks = async (pgNo) => {
    try {
        ...
        const fetchPageApi = await fetch(`https://www.anapioficeandfire.com/api/characters?page=${page_index}&pageSize=50`)
